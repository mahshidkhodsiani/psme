    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8 col-sm-12">
                <h3 style="background-color: #dbd50c;" class="d-flex justify-content-center mt-2 p-3">مدیریت قطعات تولید شده : </h3>
                <table class="table border">
                    ...
                    <tbody>
                        ...
                        // Fetch records
                        $sql = "SELECT * FROM pieces LIMIT $start_from, $results_per_page";
