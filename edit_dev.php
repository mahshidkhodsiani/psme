    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8 col-sm-12">
                <h3 style="background-color: #fcb321;" class="d-flex justify-content-center mt-2 p-3">فرم ویرایش دستگاه : </h3>
                <?php
                ...
                <form id="newPieceForm" action="" method="POST" enctype="multipart/form-data" class="p-3 border mt-4">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            ...
                            <a href="new_device" class="btn btn-outline-danger">انصراف</a>
                        </div>
                    </div>
                </form>
                <?php
